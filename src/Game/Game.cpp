...
void Game::Initialize()
{
	...
	pSystem = (InputSystem*)new AudioCutOff();
	InputManager::AddInputs(pSystem, InputSystem::InputType::AUDIO_CUTOFF);
}
...
void Game::LoadContent()
{
	...
	pLevel = (Scene*)new FifthLevel();
	SceneManager::Add(pLevel, Scene::Name::FIFTH_LEVEL);
	pLevel = (Scene*)new EighthLevel();
	SceneManager::Add(pLevel, Scene::Name::EIGHTH_LEVEL);
	...
	AudioManager::SetVolume(Audio::Name::RED_BIRD_YELL, 1.0f);
	...
	DebugMsg::out("\nKey 1 : Level 1 Normal level");
	DebugMsg::out("\nKey 2 : Level 2 Inverse Gravity");
	DebugMsg::out("\nKey 3 : Level 3 Seesaw");
	DebugMsg::out("\nKey 4 : Level 4 Ferris");
	DebugMsg::out("\nKey 5 : Level 5 Rope");
	DebugMsg::out("\nKey R : Reload Sling\n");
}
