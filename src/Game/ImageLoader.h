...
void LoadImages()
{
	...
	ImageMan::addImage(ImageName::Name::BombBird1, TextName::AngryBirds, Rect(668, 678, 63, 72)); // Bomb 1
	ImageMan::addImage(ImageName::Name::BombBird2, TextName::AngryBirds, Rect(777, 446, 62, 80)); // Bomb 2
	ImageMan::addImage(ImageName::Name::BombBird3, TextName::AngryBirds, Rect(714, 446, 61, 80)); // Bomb 3
	ImageMan::addImage(ImageName::Name::BombBird4, TextName::AngryBirds, Rect(409, 808, 60, 80)); // Bomb 4
	ImageMan::addImage(ImageName::Name::BombBird5, TextName::AngryBirds, Rect(587, 446, 62, 80)); // Bomb 5
	ImageMan::addImage(ImageName::Name::BombBird6, TextName::AngryBirds, Rect(651, 446, 61, 80)); // Bomb 6
	...
	ImageMan::addImage(ImageName::Name::WhiteBird1, TextName::AngryBirds, Rect(492, 353, 86, 91)); // White Bird 1
	ImageMan::addImage(ImageName::Name::WhiteBird3, TextName::AngryBirds, Rect(409, 638, 79, 85)); // White Bird 3
	ImageMan::addImage(ImageName::Name::WhiteBird5, TextName::AngryBirds, Rect(668, 752, 50, 66)); // White Bird 5
	ImageMan::addImage(ImageName::Name::BlueBird0, TextName::AngryBirds, Rect(1, 379, 31, 30)); // Blue Bird 0
	ImageMan::addImage(ImageName::Name::BlueBird1, TextName::AngryBirds, Rect(1, 411, 31, 30)); // Blue Bird 1
	ImageMan::addImage(ImageName::Name::BlueBird2, TextName::AngryBirds, Rect(1, 538, 30, 29)); // Blue Bird 2
	ImageMan::addImage(ImageName::Name::BlueBird3, TextName::AngryBirds, Rect(1, 508, 30, 28)); // Blue Bird 3
