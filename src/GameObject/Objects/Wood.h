...
public:
	...
	virtual void CollideVisit(YellowBird&, b2Contact*, const b2ContactImpulse*) override;
	virtual void CollideVisit(BlueBird&, b2Contact*, const b2ContactImpulse*) override;
	virtual void CollideVisit(Bomb&, b2Contact*, const b2ContactImpulse*) override;
	...
	virtual void CollideVisit(BlastSensor&, b2Contact*, const b2ContactImpulse*) override;
	virtual void CollideVisit(Egg&, b2Contact*, const b2ContactImpulse*) override;
	virtual void CollideVisit(BigBird&, b2Contact*, const b2ContactImpulse*) override;
