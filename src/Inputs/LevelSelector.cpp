...
void LevelSelector::Update()
{
	...
	else if (!(SceneManager::GetCurrentScene() == Scene::Name::FIFTH_LEVEL)
		&& Keyboard::GetKeyState(AZUL_KEY::KEY_4))
	{
		SceneManager::SetCurrentScene(Scene::Name::FIFTH_LEVEL);
	}
	else if (!(SceneManager::GetCurrentScene() == Scene::Name::EIGHTH_LEVEL)
		&& Keyboard::GetKeyState(AZUL_KEY::KEY_5))
	{
		SceneManager::SetCurrentScene(Scene::Name::EIGHTH_LEVEL);
	}
